#I had to make a copy of the test.py file because in collab they already have a module called test and it would always try to import functions from there
#I dont want to waste a ton of time on package managing in collab so I figured the easiest way is to just make a copy of the test.py file and call it differently
